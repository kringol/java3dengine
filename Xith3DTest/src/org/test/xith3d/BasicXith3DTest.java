...
public class BasicXith3DTest {
    ...
    protected static final String TDS_MODEL_FILENAME = "resources/models/3ds/tank.3ds";//"resources/models/3ds/basicScene.3ds";
    ...
    public void showBasicScene(){
        ...
        Canvas3DWrapper canvas = Canvas3DWrapper.createStandalone(CanvasPeer.OpenGLLayer.JOGL,
                Canvas3DWrapper.Resolution.RES_800X600,
        ...
        //assert BranchGroup.class.isAssignableFrom(scene.getClass());
        BranchGroup bg = new BranchGroup();
        bg.addChild(scene);
        environment.addBranchGraph(bg);

        environment.getView().lookAt(
                new Vector3f(50,35,50),
                new Vector3f(0,0,0),
                new Vector3f(0,1,0));
        ...
        GeoSphere sph = new GeoSphere( 8, GeometryArray.COLOR_3 |
                GeometryArray.NORMALS, 7f );
